                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button--group">
                                            ...
                                            @else
                                                @if($data->is_hidden == Status::NO)
                                                    <button class="btn btn-sm btn-outline--warning confirmationBtn"
                                                        data-action="{{ route('admin.frontend.manage.pages.hide',$data->id) }}"
                                                        data-question="@lang('Are you sure to hide this page?')">
                                                        <i class="las la-eye"></i> @lang('Hide')
                                                    </button>
                                                @else
                                                    <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                        data-action="{{ route('admin.frontend.manage.pages.show',$data->id) }}"
                                                        data-question="@lang('Are you sure to show this page?')">
