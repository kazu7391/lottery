        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">@lang('Select Balls')</h5>
                </div>
                <div class="card-body d-flex flex-column align-content-center">
                    @for ($x = 1; $x <= $lottery->no_of_ball; $x++)
                        <div class="d-flex align-content-center">
                            <span class="align-self-center" style="width: 50px;">Ball {{ $x }}</span>
                            <div class="lottery-balls d-flex">
                                @for ($y = 0; $y <= 9; $y++)
                                    <span class="normalBtn" style="font-size: 16px; width: 50px; height: 50px; line-height: 50px;" data-normal_ball="{{ $y }}">{{ $y }}</span>
                                @endfor
                            </div>
                        </div>
                    @endfor
