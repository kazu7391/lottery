                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control win_times" min="0" name="winning[{{ $key }}][win_times]" value="{{@$winningSetting ? getAmount($winningSetting->win_times) : '' }}" required step="any" type="number">
