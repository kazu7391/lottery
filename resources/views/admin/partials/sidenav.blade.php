    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.draw.pending') }}">
                    <a class="nav-link " href="{{ route('admin.draw.pending') }}">
                        <i class="menu-icon las la-ticket-alt"></i>
                        <span class="menu-title">@lang('Pending Draw')</span>
                        @if ($pendingDrawCount)
                            <span class="menu-badge pill bg--danger ms-auto">{{ $pendingDrawCount }}</span>
                        @endif
                    </a>
                </li>
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive('admin.lottery*', 3) }}" href="javascript:void(0)">
                        <i class="menu-icon las la-ticket-alt"></i>
                        <span class="menu-title">@lang('Manage Lottery')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.lottery*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive(['admin.lottery.index', 'admin.lottery.create']) }} ">
                                <a class="nav-link" href="{{ route('admin.lottery.index') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Lotteries')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.lottery.phase.all') }} ">
                                <a class="nav-link" href="{{ route('admin.lottery.phase.all') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.coin.request.log') }}">
                    <a class="nav-link " href="{{ route('admin.coin.request.log') }}">
                        ...
                        <span class="menu-title">@lang("$general->cur_text Request")</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive('admin.deposit*', 3) }}" href="javascript:void(0)">
                        ...
                        <span class="menu-title">@lang('Manage Payment')</span>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.pending') }} ">
                                <a class="nav-link" href="{{ route('admin.deposit.pending') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending') {{depositKeyword()}}</span>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.approved') }} ">
                                <a class="nav-link" href="{{ route('admin.deposit.approved') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved') {{depositKeyword()}}</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.successful') }} ">
                                <a class="nav-link" href="{{ route('admin.deposit.successful') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Successful') {{depositKeyword()}}</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.rejected') }} ">
                                <a class="nav-link" href="{{ route('admin.deposit.rejected') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected') {{depositKeyword()}}</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.initiated') }} ">
                                ...
                                <a class="nav-link" href="{{ route('admin.deposit.initiated') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Initiated') {{depositKeyword()}}</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.deposit.list') }} ">
                                <a class="nav-link" href="{{ route('admin.deposit.list') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All') {{depositKeyword()}}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.ticket.*') }}">
                                <a class="nav-link" href="{{ route('admin.report.ticket.purchase.history') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Ticket Parchase History')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.report.winning.*') }}">
                                <a class="nav-link" href="{{ route('admin.report.winning.history') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Winning History')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.setting.coin.instruction') }}">
                    <a class="nav-link" href="{{ route('admin.setting.coin.instruction') }}">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang(" $general->cur_text Instruction")</span>
                    </a>
                </li>
