                            ...
                            @forelse ($languages as $item)
                                <tr>
                                    <td>
                                        <div class="user">
                                            <div class="thumb">
                                                <img  src="{{ getImage(getFilePath('language') . '/' . $item->flag, getFileSize('language')) }}">
                                            </div>
                                    ...
                                    <td>
                                        <div class="button--group">
                                            ...
                                            @if($item->is_hidden == Status::NO)
                                                <button class="btn btn-sm btn-outline--warning confirmationBtn"
                                                    data-action="{{ route('admin.language.manage.hide',$item->id) }}"
                                                    data-question="@lang('Are you sure to hide this language?')">
                                                    <i class="las la-eye"></i> @lang('Hide')
                                                </button>
                                            @else
                                                <button class="btn btn-sm btn-outline--success confirmationBtn"
                                                    data-action="{{ route('admin.language.manage.show',$item->id) }}"
                                                    data-question="@lang('Are you sure to show this language?')">
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ route('admin.language.manage.store')}}">
                    @csrf
