        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                    ...
                    <a class="btn btn--secondary btn--smd" href="{{ route('user.cashout.history') }}"><i class="las la-long-arrow-alt-left"></i> @lang('History')</a>
                </div>
                <div class="card custom--card">
                    <div class="card-body">
                        <form action="{{ route('user.cashout.money') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control form--control" name="amount" required step="any" type="number" value="{{ old('amount') }}">
