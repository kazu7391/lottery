<div class="dashboard-sidebar bg--dark" id="dashboard-sidebar">
    <button class="btn-close dash-sidebar-close d-xl-none"></button>
    <div id="dashboard-sidebar-wrapper">
        ...
        <div class="bg--lights">
            <div class="profile-info">
                <p class="fs--13px mb-3 fw-bold text-white">@lang('ACCOUNT BALANCE')</p>
                ...
                <div class="mt-4 d-flex flex-wrap gap-1">
                    ...
                    <a class="btn btn--secondary btn--smd" href="{{ route('user.cashout')}}">{{withrdawKeyword()}}</a>
                </div>
            </div>
        </div>
        <ul class="sidebar-menu">
            ...
            <li>
                <a class="{{ menuActive('user.deposit*') }}{{ menuActive('user.cashout*') }}{{ menuActive('user.transactions') }}" href="javascript:void(0)"><img alt="icon" src="{{ asset($activeTemplateTrue . '/images/icon/wallet.png') }}"> @lang('Monye') {{coinName()}}</a>
                <div class="sidebar-submenu {{ menuActive('user.deposit*') }}{{ menuActive('user.cashout*') }}{{ menuActive('user.transactions') }}">
                    <ul>
                        <li>
                            <a class="{{ menuActive('user.deposit*') }}" href="{{ route('user.deposit.index') }}">
                                <!-- <img alt="icon" src="{{ asset($activeTemplateTrue . '/images/icon/wallet.png') }}">  -->
                                @lang('Purchase')
                            </a>
                        </li>
                        <li>
                            <a class="{{ menuActive('user.cashout*') }}" href="{{ route('user.cashout') }}">
                                <!-- <img alt="icon" src="{{ asset($activeTemplateTrue . '/images/icon/withdraw.png') }}"> -->
                                {{withrdawKeyword()}}
                            </a>
                        </li>
                        <li>
                            <a class="{{ menuActive('user.transactions') }}" href="{{ route('user.transactions') }}">
                                <!-- <img alt="icon" src="{{ asset($activeTemplateTrue . '/images/icon/transaction.png') }}">  -->
                                @lang('Transactions')
                            </a>
                        </li>
                    </ul>
            ...
            <li>
                <a class="{{ menuActive(['ticket.index', 'ticket.view', 'ticket.open']) }}{{ menuActive('user.twofactor') }}{{ menuActive('user.change.password') }}" href="javascript:void(0)"><img alt="icon" src="{{ asset($activeTemplateTrue . '/images/icon/profile.png') }}"> @lang('My Profile')</a>            
                <div class="sidebar-submenu {{ menuActive(['ticket.index', 'ticket.view', 'ticket.open']) }}{{ menuActive('user.twofactor') }}{{ menuActive('user.change.password') }}">
                    <ul>
                        <li>
                            <a class="{{ menuActive(['ticket.index', 'ticket.view', 'ticket.open']) }}" href="{{ route('ticket.index') }}">
                                <!-- <img alt="icon" src="{{ asset($activeTemplateTrue . '/images/icon/ticket.png') }}">  -->
                                @lang('Support Ticket')
                            </a>
                        </li>
                        <li>
                            <a class="{{ menuActive('user.twofactor') }}" href="{{ route('user.twofactor') }}">
                                <!-- <img alt="icon" src="{{ asset($activeTemplateTrue . '/images/icon/2fa.png') }}">  -->
                                @lang('2FA Security')
                            </a>
                        </li>
                        <li>
                            <a class="{{ menuActive('user.change.password') }}" href="{{ route('user.change.password') }}">
                                <!-- <img alt="icon" src="{{ asset($activeTemplateTrue . '/images/icon/password.png') }}">  -->
