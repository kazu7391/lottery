...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('LanguageController')->prefix('language')->name('language.')->group(function () {
        ...
        Route::post('hide/{id}', 'langHide')->name('manage.hide');
        Route::post('show/{id}', 'langShow')->name('manage.show');
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        Route::post('coin-instruction', 'coinInstructionUpdate')->name('setting.coin.instruction');
    ...
    Route::name('frontend.')->prefix('frontend')->group(function () {
        ...
        Route::controller('PageBuilderController')->group(function () {
            ...
            Route::post('manage-pages/hide/{id}', 'managePagesHide')->name('manage.pages.hide');
            Route::post('manage-pages/show/{id}', 'managePagesShow')->name('manage.pages.show');
